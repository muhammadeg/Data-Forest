...
static int (__cdecl *Random)() = (int (__cdecl*)())0x0040B500;
static LONG (__stdcall *BuffRemain)(int PID,int BuffID, int Time, int Type) = (LONG (__stdcall*)(int,int,int,int))0x00415180;
